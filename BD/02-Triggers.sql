...
WHERE
    idCancion = new.idCancion;

END $$ -- 2) Cada vez que se actualiza el contador de la caanción en N reproducciones, se incrementa el contador del álbum también en N.
